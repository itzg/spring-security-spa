 ...
 * @since Mar 2018
 */
public class SimpleLogoutSuccessHandlerTest {

    @Test
    public void onLogoutSuccess() throws IOException, ServletException {
        final SimpleLogoutSuccessHandler handler = new SimpleLogoutSuccessHandler();
        ...
        assertThat(resp.getStatus()).isEqualTo(SimpleLogoutSuccessHandler.STATUS_CODE);
    }
}